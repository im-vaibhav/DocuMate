...
const GoogleAuth = ({ onSuccess }) => {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className='w-full flex items-center justify-center gap-3 py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
    >
      {isLoading ? (
